...
CREATE TABLE seconds_duration (
	id INT(100) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	songs_id INT(100) NOT NULL,
...
INSERT INTO songs (albums_id, song, release_year_id) VALUES
	(1, 'Soul For Us', 1),
    (1, 'Reflections Of Magic', 1),
    (1, 'Dance With Her Own', 1),
    (2, 'Troubles Of My Inner Fire', 2),
    (2, 'Time Fireworks', 2),
    (3, 'Magic Circus', 3),
    (3, 'Honey, So Do I', 3),
    (3, 'Sweetie, Let s Go Wild', 3),
    (3, 'She Knows', 3),
    (4, 'Fantasy For Me', 4),
    (4, 'Celebration Of More', 4),
    (4, 'Rock His Everything', 4),
    (4, 'Home Forever', 4),
    (4, 'Diamond Power', 4),
    (4, "Let's Be Silly", 4),
    (5, 'Thang Of Thunder', 5),
    (5, 'Words Of Her Life', 5),
    (5, 'Without My Streets', 5),
    (6, 'Need Of The Evening', 6),
    (6, 'History Of My Roses', 6),
    (6, 'Without My Love', 6),
	(6, 'Walking And Game', 6),
    (6, 'Young And Father', 6),
    (7, 'Finding My Traditions', 7),
	(7, 'Walking And Man', 7),
    (7, 'Hard And Time', 7),
    (7, "Honey, I'm A Lone Wolf", 7),
	(8, 'She Thinks I Wont s Stay Tonight', 8),
    (8, 'He Heard You re Bad For Me', 8),
    (8, 'He Hopes We Can t Stay', 8),
    (8, 'I Know I Know', 8),
    (9, 'He s Walking Away', 9),
    (9, 'He s Trouble', 9),
    (9, 'I Heard I Want To Bo Alone', 9),
    (9, 'I Ride Alone', 9),
    (10, 'Honey', 9),
    (10, 'You Cheated On Me', 9),
    (10, 'Wouldn t It Be Nice', 9),
    (10, 'Baby', 9),
    (10, 'You Make Me Feel So..', 9);
...
INSERT INTO seconds_duration (duration, songs_id) VALUES
	(200, 1),
    (163, 2),
    (116, 3),
    (203, 4),
